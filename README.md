...
A Sega Genesis emulator designed for running in vanilla JavaScript pre-ECMAScript 2015 (no WebAssembly). Simply open the link below, click the red icon, and select a ROM file in `BIN` format from your computer; it will be loaded and booted automatically.
...
Examples of loading local and online files can be found [here](https://github.com/lrusso/Genesis/blob/main/Genesis.htm#L120-L164) and [here](https://github.com/lrusso/Genesis/blob/main/Genesis.htm#L175-L213).
